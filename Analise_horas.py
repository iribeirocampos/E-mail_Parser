...
def data_anal():
    ...
    data["Data"] = data.Data.str.split("+", expand=True)
    data[["Data", "Hora"]] = data.Data.str.split(
        " ", expand=True
    ...
    df_final.insert(
        0, column="Dia", value=df_final["Data"].dt.day, allow_duplicates=False
    )
    df_final.insert(
        0, column="Mês", value=df_final["Data"].dt.month, allow_duplicates=False
    )
    df_final.insert(
        0, column="Ano", value=df_final["Data"].dt.year, allow_duplicates=False
    )
